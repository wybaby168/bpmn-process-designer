<template>
  <div class="process-container my-process-designer">
    <div class="my-process-designer__header">
      ...
      <template v-if="!$slots['control-header']">
        <el-button-group key="file-control">
          <el-button :size="headerButtonSize" :type="headerButtonType" icon="el-icon-edit-outline" @click="handleSave">
            保存流程
          </el-button>
    ...
    <el-dialog custom-class="wf-container" append-to-body title="预览" width="60%" :visible.sync="previewModelVisible" destroy-on-close>
