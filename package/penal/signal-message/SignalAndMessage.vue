<template>
  <div class="panel-tab__content">
    ...
    <el-dialog custom-class="wf-container" append-to-body :visible.sync="modelVisible" :title="modelConfig.title" :close-on-click-modal="false" width="400px" destroy-on-close>
