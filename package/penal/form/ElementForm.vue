<template>
  <div class="panel-tab__content">
    ...
    <!--字段配置侧边栏-->
    <el-drawer custom-class="wf-container" append-to-body :visible.sync="fieldModelVisible" title="字段配置" :size="`${width}px`" destroy-on-close>
    ...
    <el-dialog custom-class="wf-container" append-to-body :visible.sync="fieldOptionModelVisible" :title="optionModelTitle" width="600px" destroy-on-close>
